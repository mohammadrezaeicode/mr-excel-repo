...
function Q(o) {
  ...
  return c.length == 4 && c[3] == "0" || !l ? null : (yo(c[0]) + yo(c[1]) + yo(c[2])).toUpperCase();
}
function bo(o, c) {
...
const zo = function(o, c, l, e = []) {
  ...
  if (typeof o == "object" && Array.isArray(o))
    ...
    r = o;
  if (c < Lo.length) {
    let b = "color" + (l && l.rIndex ? l.rIndex : 4).toString(), a = "color" + (l && l.hIndex ? l.hIndex : 1).toString(), s = Lo[c], y = s[a], i = s[b], _;
    l != null && l.hColor ? _ = l == null ? void 0 : l.hColor : _ = l && l.nColor ? Po(y) : Ro(y);
    let w;
    l != null && l.rColor ? w = l == null ? void 0 : l.rColor : w = l && l.nColor ? Po(i) : Ro(i), typeof r.styles > "u" && (r.styles = {}), r.styles.themeStyleHeader = {
      fg: y,
      fontColor: _
    ...
    const I = r.sheet.length;
    for (let v = 0; v < I; v++)
      r.sheet[v].styleCellCondition = function(n, f, F, P, N, O) {
        return N ? "themeStyleHeader" : "themeStyleBody";
      };
  }
  return typeof (l == null ? void 0 : l.fieName) == "string" && (r.fileName = l.fieName), r;
};
function Uo(o, c, l, e, r, b, a, s) {
  let y = [], i = "both", _ = [];
  !c || c === 0 ? (c = 1, i = "col") : _.push(c - 1), !o || o === 0 ? (o = 0, i = "row") : _.push(o - 1);
  let w = r || {};
  w.mergeType = s && s.mergeType ? [...s.mergeType, i] : [i], w.mergeValue = s && s.mergeValue ? [...s.mergeValue, _] : [_], w.mergeStart = s && s.mergeStart ? [...s.mergeStart, l] : [l];
  for (let I = 0; I < c; I++) {
    let v = o;
    for (let n = 0; n < e; n++)
      l <= n ? v >= 1 ? (w["c" + n] = b, b = "", a += "*", v--) : c >= 2 && l == n ? (w["c" + n] = b, b = "", a += "+") : a += "-" : I > 0 && (a += "-");
    y.push({
      ...w,
      mergeString: a
    }), w = {}, a = "";
...
function Vo(o, c, l, e, r) {
  ...
  if (b) {
    let I = !1, v = 0;
    b.forEach((n, f) => {
      var F = [].slice.call(n.children);
      const P = window.getComputedStyle(n, null);
      let N = Q(P.backgroundColor);
      if (!I)
        v = F.length, I = !0, typeof e == "function" ? i = e(
          ...
          let S = window.getComputedStyle(O, null), D = null;
        ...
        let O = {}, J = "", S = !1;
        s.length >= f && (O = s[f - 1], J = "mergeString" in O ? O.mergeString : "", S = !0);
        let D = 0;
        F.forEach((V, E) => {
          if ("c" + (E + D) in O)
          ...
          if (V.getAttribute("colspan") || V.getAttribute("rowspan")) {
            ...
            s.length < f ? s.push(...z) : z.forEach((ho, ro) => {
              s.length < f + ro ? s.push(...z) : s[f + ro] = {
                ...s[f + ro],
                ...ho
              };
            }), O = z[0], J = z[0].mergeString, S = !0;
          } else
            S || (J += "-");
          let $ = null;
          T.borderBottomWidth !== "0px" && ($ || ($ = {}), $.bottom = {
            style: "thin",
            color: Q(T.borderBottomColor)
          }), T.borderTopWidth !== "0px" && ($ || ($ = {}), $.top = {
            style: "thin",
            color: Q(T.borderTopColor)
          }), T.borderLeftWidth !== "0px" && ($ || ($ = {}), $.left = {
            style: "thin",
            color: Q(T.borderLeftColor)
          }), T.borderRightWidth !== "0px" && ($ || ($ = {}), $.right = {
            style: "thin",
            color: Q(T.borderRightColor)
          });
          let q = Q(T.backgroundColor);
          !q && N && (q = N);
          let oo = {
            ...q ? { fg: q } : {},
          ...
          y.header[f + "-" + E] = oo, O["c" + E] = V.textContent;
        }), typeof e == "function" ? O.height = e(
          Number(P.height.substring(0, P.height.length - 2)),
          f,
          !1
        ) : O.height = P.height.substring(0, P.height.length - 2), s.length < f ? s.push(O) : s[f - 1] = O;
      }
    });
  } else
  ...
  return {
    ...
    sheet: [
      {
        headerHeight: i,
        styleCellCondition: function(I, v, n, f, F, P) {
          return l ? P.includes(f - 1 + "-" + n) ? f - 1 + "-" + n : "" : null;
        },
        data: s,
        headers: a
      }
...
function wo(o, c, l = "", e = [], r = 0) {
  const b = o.length;
  for (let a = 0; a < b; a++)
    e.push(l + o[a]);
  return c < e.length ? e : wo(
    o,
    c,
    e[r + 1],
    e,
...
function Ko(o, c, l, e) {
  return `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"> <Default Extension="rels"  ContentType="application/vnd.openxmlformats-package.relationships+xml"/> <Default Extension="vml" ContentType="application/vnd.openxmlformats-officedocument.vmlDrawing" /> <Default Extension="xml" ContentType="application/xml" /><Override ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet.main+xml" PartName="/xl/workbook.xml" /><Override ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.styles+xml" PartName="/xl/styles.xml" /><Override ContentType="application/vnd.openxmlformats-officedocument.theme+xml" PartName="/xl/theme/theme1.xml" />` + l.reduce((r, b) => b == "svg" ? r + `<Default Extension="png" ContentType="image/png"/>
                    <Default Extension="svg" ContentType="image/svg+xml"/>` : b == "jpeg" || b == "jpg" ? r + `<Default Extension="${b}" ContentType="image/jpeg"/>` : r + `<Default Extension="${b}" ContentType="image/${b}" />`, "") + c.reduce((r, b) => r + `
    <Override PartName="/xl/comments${b}.xml"
        ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.comments+xml" />`, "") + o + '<Override ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.sharedStrings+xml" PartName="/xl/sharedStrings.xml" /> <Override PartName="/docProps/core.xml"  ContentType="application/vnd.openxmlformats-package.core-properties+xml" />' + e.reduce((r, b) => r + `<Override PartName="/xl/drawings/${b}"
...
function Co(o, c, l) {
  ...
  if (typeof o == "object") {
    ...
    r = "comment" in o && typeof o.comment == "string" ? Eo(o.comment) : [""];
  } else
    r = o ? Eo(o) : [""];
...
function vo(o, c, l, e) {
  let r = `<comment ref="${o}" authorId="${Math.max(
    0,
    e - 1
  )}" shapeId="0">
            <text>`, b = "";
  ...
  if (e) {
    ...
    r.forEach((v, n) => {
      ...
      if (f)
        if (s) {
          let F;
          y ? F = no(f, v) : F = v.split(o), i.push(...F), _.push(...f), w.push(
            ...f.reduce((P, N) => [...P, c], [])
          );
        } else {
          let F;
          y ? F = no(f, v) : F = v.split(o).reduce((P, N, O) => O >= 2 ? (P[1] += o + N, P) : [...P, N], []), i.push(...F), w.push(c), _.push(o.toString());
        }
      else
        i.push(v);
      I > n && (_.push(b[n]), w.push(a[n]));
    }), r = i, b = _, a = w;
  } else {
    let i;
    try {
    ...
    i ? s ? (b.push(...i), a.push(
      ...i.reduce((_, w) => [..._, c], [])
    ), y ? r = no(i, l) : r = l.split(o)) : (b.push(o.toString()), a.push(c), y ? r = no(i, l) : r = l.split(o).reduce((_, w, I) => I >= 2 ? (_[1] += o + w, _) : [..._, w], [])) : r.push(l), e = !0;
  }
  return {
    v: o,
    text: l,
  ...
  if (typeof o == "object") {
    ...
    if (Object.keys(o).forEach((v) => {
      ...
      if (v !== "reg") {
        ...
        i = f.textSplited, y = f.splitValue, a = f.matchValue, s = f.styleMatchValue;
      }
    ...
    const w = y.length - 1, I = e in l ? l[e] : "";
    for (let v = 0; v < w; v++) {
      const n = y[v], f = a[v], F = s[v];
      n.length > 0 && (b += `<r>
        ${I}
...
const Yo = {
  ...
  "Y",
  "Z"
], Zo = (o, c) => fetch(o).then((l) => (console.log(l), l.blob())).then((l) => new File([l], c)).catch((l) => {
  console.error(l);
});
function jo(o, c) {
  ...
  let r = c.indexOf(l);
  return r < 0 && (c = wo(c, Math.pow(10, l.length + 1), ""), r = c.indexOf(l), r < 0 && (r = 0)), {
    col: r,
    row: e
  };
}
async function Qo(o) {
  let c = [...Jo];
  o.numberOfColumn && o.numberOfColumn > 25 && (c = wo(c, o.numberOfColumn));
  const e = (await import("./jszip.min-e651e8fb.mjs").then((g) => g.j)).default;
  let r = new e();
  const b = o.sheet.length;
  let a = r.folder("xl"), s = a == null ? void 0 : a.folder("media"), y = a == null ? void 0 : a.folder("drawings"), i = y == null ? void 0 : y.folder("_rels");
  ...
  const _ = Object.keys(o.styles), w = Xo;
  let I = _.reduce(
    (g, t, h) => {
      const p = o.styles[t], L = {
        fillIndex: 0,
        fontIndex: 0,
        borderIndex: 0,
        formatIndex: 0
      ...
      if (p.fg) {
        ...
        L.fillIndex = g.fill.count, g.fill.count++, g.fill.value = g.fill.value + '<fill><patternFill patternType="solid">' + (B ? '<fgColor rgb="' + B.replace("#", "") + '" />' : "") + "</patternFill></fill>";
      }
      if (p.fontColor || p.fontFamily || p.size || p.bold || p.italic || p.underline || p.doubleUnderline) {
        const B = bo(p.fontColor, o.backend);
        L.fontIndex = g.font.count, g.font.count++, g.font.value = g.font.value + "<font>" + (p.bold ? "<b/>" : "") + (p.italic ? "<i />" : "") + `${p.underline || p.doubleUnderline ? `<u ${p.doubleUnderline ? ' val="double" ' : ""}/>` : ""}` + (p.size ? '<sz val="' + p.size + '" />' : "") + (B ? '<color rgb="' + B.replace("#", "") + '" />' : "") + (p.fontFamily ? '<name val="' + p.fontFamily + '" />' : "") + "</font>", g.commentSintax.value[t] = `<rPr>
            ${p.bold ? "<b/>" : ""}
            ${p.italic ? "<i />" : ""}
            ${p.underline || p.doubleUnderline ? `<u ${p.doubleUnderline ? ' val="double" ' : ""}/>` : ""}
            <sz val="${p.size ? `${p.size}` : "9"}" />
            ${B ? `<color rgb="${B.replace("#", "")}" />` : ""}
            <rFont val="${p.fontFamily ? `${p.fontFamily}` : "Tahoma"}" />
        </rPr>
        `;
      }
      let lo = "/>";
      p.alignment && (p.alignment.rtl && (p.alignment.readingOrder = 2), delete p.alignment.rtl, p.alignment.ltr && (p.alignment.readingOrder = 1), delete p.alignment.ltr, lo = ' applyAlignment="1"><alignment ' + Object.keys(p.alignment).reduce((B, Z) => B + " " + Z + '="' + p.alignment[Z] + '" ', "") + " /></xf>");
      const x = p.border;
      let X = "";
      if (typeof x == "object" && ((x.left || x.full) && (X += '<left style="' + (x.left || x.full).style + '"><color rgb="' + bo(
        (x.left || x.full).color,
        o.backend
      ).replace("#", "") + '" /></left>'), (x.right || x.full) && (X += '<right style="' + (x.right || x.full).style + '"><color rgb="' + bo(
        (x.right || x.full).color,
        o.backend
      ).replace("#", "") + '" /></right>'), (x.top || x.full) && (X += '<top style="' + (x.top || x.full).style + '"><color rgb="' + bo(
        (x.top || x.full).color,
        o.backend
      ).replace("#", "") + '" /></top>'), (x.bottom || x.full) && (X += '<bottom style="' + (x.bottom || x.full).style + '"><color rgb="' + bo(
        (x.bottom || x.full).color,
        o.backend
      ).replace("#", "") + '" /></bottom>'), L.borderIndex = g.border.count, g.border.count++, g.border.value += "<border>" + X + "<diagonal /></border>"), p.format) {
        const B = Yo[p.format];
        B && (L.formatIndex = B.key, "value" in B && (g.format.count++, g.format.value += B.value));
      }
      return g.cell.value = g.cell.value + '<xf numFmtId="' + L.formatIndex + '" fontId="' + L.fontIndex + '" fillId="' + L.fillIndex + '" borderId="' + L.borderIndex + '" xfId="0"' + (L.borderIndex > 0 ? ' applyBorder="1" ' : "") + (L.fillIndex > 0 ? ' applyFill="1" ' : "") + (L.fontIndex >= 0 ? ' applyFont="1" ' : "") + (L.formatIndex > 0 ? ' applyNumberFormat="1" ' : "") + lo, o.styles[t].index = g.cell.count, g.cell.count++, g;
    },
    {
      commentSintax: {
        value: {}
  ...
  a == null || a.file("styles.xml", Wo(I));
  let v = '<Override ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml" PartName="/xl/worksheets/sheet1.xml" />', n = "", f = 0, F = "", P = "", N = {};
  const O = {};
  let J = "", S = 4, D = !1, V = [];
  for (let g = 0; g < b; g++) {
    const t = o.sheet[g];
    let h = t.shiftTop ? t.shiftTop : 1, p = "", L = "", lo = "", x = Object.assign([], t.merges), X = Object.assign({}, t.formula), B = !1, Z = [], po = "", uo = [], To = [], io = [], to = {}, mo;
    t.images && (mo = Promise.all([
      ...t.images.map(async (W, U) => {
        let Y = W.url.lastIndexOf("."), d;
        return Y > 0 ? (d = W.url.substring(Y + 1).toLowerCase(), d.length > 4 && (d.indexOf("gif") >= 0 ? d = "gif" : d.indexOf("jpg") >= 0 ? d = "jpg" : d.indexOf("jpeg") >= 0 ? d = "jpeg" : d = "png")) : d = "png", V.push(d), {
          type: d,
          image: await Zo(W.url, "image" + U + "." + d),
          obj: W,
          i: U
        };
      })
    ...
    if (Array.isArray(t.headers) && ao) {
      let W = "";
      if (t.title) {
        const d = t.title, C = d.comment, j = d.shiftTop ? d.shiftTop : 0, H = t.shiftLeft ? t.shiftLeft : 0, u = d.shiftLeft ? d.shiftLeft + H : H, R = d.consommeRow ? d.consommeRow - 1 : 1, fo = d.consommeCol ? d.consommeCol : ao, A = R == 0 && typeof d.height == "number" ? ' ht="' + d.height + '" customHeight="1" ' : "", M = d.styleId ? d.styleId : "titleStyle", m = c[u] + "" + (h + j);
        if (x.push(
          m + ":" + c[u + fo - 1] + (h + R + j)
        ), typeof C < "u") {
          B = !0;
          const k = Co(
            C,
            I.commentSintax.value,
            w
          );
          let K = Z.length;
          if (k.hasAuthour && typeof k.author < "u") {
            let co = k.author.toString();
            const G = Z.indexOf(co);
            G < 0 ? Z.push(co) : K = G;
          }
          uo.push({
            row: h + j - 1,
        ...
        typeof d.text == "string" && (W += '<row r="' + (h + j) + '" ' + A + ' spans="1:' + (u + fo - 1) + '">', W += '<c r="' + m + '" ' + (o.styles[M] ? ' s="' + o.styles[M].index + '" ' : "") + ' t="s"><v>' + f + "</v></c>", W += "</row>", f++, N[d.text] = d.text, d.multiStyleValue ? n += So(
          d.multiStyleValue,
          d.text,
          I.commentSintax.value,
          M,
          t.useSplitBaseOnMatch
        ) : n += "<si><t>" + d.text + "</t></si>"), h += j + R + 1;
      }
      let U = t.headerStyleKey ? t.headerStyleKey : null, Y = 0;
      if (typeof t.shiftLeft == "number" && (Y = t.shiftLeft), t.headers.forEach((d, C) => {
        if (Y && (C += Y), d.formula && io.push(C), To.push(d.label), t.mergeRowDataCondition && typeof t.mergeRowDataCondition == "function" && t.mergeRowDataCondition(
          d,
          null,
          C,
          !0
          ...
          !0,
          _
        ) || U), d.size && d.size > 0 && (L += '<col min="' + (C + 1) + '" max="' + (C + 1) + '" width="' + d.size + '" customWidth="1" />'), t.withoutHeader)
          return;
        const j = c[C] + "" + h;
        ...
        if (H)
          ...
          d.multiStyleValue ? n += So(
            d.multiStyleValue,
            d.text,
            I.commentSintax.value,
            U || "",
            t.useSplitBaseOnMatch
          ) : n += "<si><t>" + d.text + "</t></si>", N[d.text] = d.text, f++;
        }
        ...
        t.data.forEach((u, R) => {
          if (u.mergeType)
            for (let A = 0; A < u.mergeType.length; A++) {
              const M = u.mergeType[A], m = u.mergeStart[A], k = u.mergeValue[g];
              let K = "";
              M == "both" ? K = c[m] + "" + h + ":" + c[m + k[1]] + (h + k[0]) : M == "col" ? K = c[m] + "" + h + ":" + c[m + k[0]] + h : K = c[m] + "" + h + ":" + c[m] + (h + k[0]), x.push(K);
            }
          const fo = u.rowStyle;
          p += '<row r="' + h + '" spans="1:' + ao + '" ' + (j in u ? 'ht="' + u[j] + '" customHeight="1"' : "") + (d in u ? ' outlineLevel="' + u[d] + '"' : "") + (C in u ? ' hidden="' + u[C] + '"' : "") + " >", To.forEach((A, M) => {
            Y && (M += Y);
            const m = u[A];
            let k = fo;
            if (t.styleCellCondition && typeof t.styleCellCondition == "function" && (k = t.styleCellCondition(
              m,
              u,
              M,
              h,
              ...
              const co = c[M];
              let G = to[co];
              K === !0 ? (!G || G && !G.inProgress) && (to[co] = {
                inProgress: !0,
                start: h
              }) : G && G.inProgress && (x.push(
                co + G.start + ":" + co + (h - 1)
              ), to[co] = {
                inProgress: !1,
                start: -1
            ...
            if (typeof m < "u") {
              ...
              if (typeof t.commentCodition == "function") {
                ...
                G && (typeof u.comment != "object" && (u.comment = {}), u.comment[A] = G);
              }
              if (typeof u.comment == "object" && A in u.comment) {
                const G = u.comment[A];
                B = !0;
                const eo = Co(
                  G,
                ...
                eo.hasAuthour && typeof eo.author < "u" && Z.push(eo.author.toString()), uo.push({
                  row: h - 1,
                  col: M
                });
                let Io = Z.length;
                if (eo.hasAuthour && typeof eo.author < "u") {
                  let Oo = eo.author.toString();
                  const Ao = Z.indexOf(Oo);
                  Ao < 0 ? Z.push(Oo) : Io = Ao;
                }
                po += vo(
                  K,
                  eo.commentStr,
              ...
              const co = X && X[K];
              if (co)
                p += xo(K, co).cell, delete X[K];
              else if (typeof m == "string") {
                if (p += '<c r="' + c[M] + h + '" t="s" ' + (k && o.styles && o.styles[k] ? 's="' + o.styles[k].index + '"' : "") + "><v>" + f + "</v></c>", typeof t.multiStyleConditin == "function") {
                  const G = t.multiStyleConditin(
                    m,
                    u,
                    A,
                    h,
                  ...
                  G && ((!("multiStyleValue" in u) || typeof u.multiStyleValue > "u") && (u.multiStyleValue = {}), u.multiStyleValue[A] = G);
                }
                "multiStyleValue" in u && u.multiStyleValue && A in u.multiStyleValue ? n += So(
                  u.multiStyleValue[A],
                  m,
                  I.commentSintax.value,
                  k || "",
                  t.useSplitBaseOnMatch
                ) : n += "<si><t>" + m + "</t></si>", N[m] = m, f++;
              } else
                p += '<c r="' + c[M] + h + '" ' + (k && o.styles && o.styles[k] ? 's="' + o.styles[k].index + '"' : "") + "><v>" + m + "</v></c>";
            }
          }), H - 1 == R && Object.keys(to).forEach((A) => {
            to[A].inProgress && x.push(
              A + to[A].start + ":" + A + h
            );
          }), h++, p += "</row>";
    ...
    const $o = t.name ? t.name : "sheet" + (g + 1), qo = t.state ? t.state : "visible";
    F += '<sheet state="' + qo + '" name="' + $o + '" sheetId="' + (g + 1) + '" r:id="rId' + (S + 1) + '" />', P += '<Relationship Id="rId' + (S + 1) + '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="worksheets/sheet' + (g + 1) + '.xml" />', J += "<vt:lpstr>" + ("sheet" + (g + 1)) + "</vt:lpstr>", D = D || !!t.selected;
    const Fo = t.sortAndfilter ? 'filterMode="1"' : "";
    let ko = !1, go = "";
    mo && (ko = !0, await mo.then((W) => {
      console.log(W, "res");
      let U = "";
      W.forEach((Y, d) => {
        const C = d + 1;
        var j = Y.image, H = Y.obj.from, u = Y.obj.to, R = Y.obj.margin, fo = Y.type, A = Y.obj.type, M = Y.obj.extent;
        typeof M > "u" && (M = {
          cx: 2e5,
          cy: 2e5
        });
        ...
        if (typeof u == "string" && u.length >= 2) {
          var k = jo(u, c);
          k.row += 1, k.col += 1, m.end = {
            ...k
          };
        }
        m.end.mR = 0, m.end.mB = 0, m.start.mL = 0, m.start.mT = 0, R && ((R.all || R.right) && (m.end.mR = R.all || R.right), (R.all || R.bottom) && (m.end.mB = R.all || R.bottom), (R.all || R.left) && (m.start.mL = R.all || R.left), (R.all || R.top) && (m.start.mT = R.all || R.top)), A == "one" ? go += `<xdr:oneCellAnchor>
        <xdr:from>
            <xdr:col>${m.start.col}</xdr:col>
            <xdr:colOff>${m.start.mT}</xdr:colOff>
            <xdr:row>${m.start.row}</xdr:row>
            <xdr:rowOff>${m.start.mL}</xdr:rowOff>
        </xdr:from>
        <xdr:ext cx="${M.cx}" cy="${M.cy}"/>
        <xdr:pic>
            <xdr:nvPicPr>
                <xdr:cNvPr id="${C}" name="Picture ${C}">
                </xdr:cNvPr>
        ...
        <xdr:clientData />
    </xdr:oneCellAnchor>` : go += `<xdr:twoCellAnchor editAs="oneCell">
        <xdr:from>
            <xdr:col>${m.start.col}</xdr:col>
            <xdr:colOff>${m.start.mT}</xdr:colOff>
            <xdr:row>${m.start.row}</xdr:row>
        ...
        <xdr:to>
            <xdr:col>${m.end.col}</xdr:col>
            <xdr:colOff>${m.end.mB}</xdr:colOff>
            <xdr:row>${m.end.row}</xdr:row>
            <xdr:rowOff>${m.end.mR}</xdr:rowOff>
        </xdr:to>
        <xdr:pic>
            <xdr:nvPicPr>
                <xdr:cNvPr id="${C}" name="Picture ${C}">
        ...
        const K = "image" + C + "." + fo;
        s == null || s.file(K, j), U += `<Relationship Id="rId${C}"
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
    ${U}
      ...
      sheetSortFilter: lo,
      tabColor: t.tabColor ? '<sheetPr codeName="' + ("Sheet" + (g + 1)) + '" ' + Fo + ' ><tabColor rgb="' + t.tabColor.replace("#", "") + '" /></sheetPr>' : "<sheetPr " + Fo + ' ><outlinePr summaryBelow="0" summaryRight="0" /></sheetPr>'
    }, S++;
  }
  let E = Object.keys(O), T = r.folder("_rels");
  T == null || T.file(
    ".rels",
    `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"> <Relationship Id="rId3"  Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/extended-properties"  Target="docProps/app.xml" /> <Relationship Id="rId2"  Type="http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties"  Target="docProps/core.xml" /> <Relationship Id="rId1"  Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument"  Target="xl/workbook.xml" /></Relationships>`
  );
  let $ = r.folder("docProps");
  $ == null || $.file(
    "core.xml",
    `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:dcmitype="http://purl.org/dc/dcmitype/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">` + (o.creator ? "<dc:creator>" + o.creator + "</dc:creator>" : "") + (o.created ? '<dcterms:created xsi:type="dcterms:W3CDTF">' + o.created + "</dcterms:created>" : "") + (o.modified ? '<dcterms:modified xsi:type="dcterms:W3CDTF">' + o.modified + "</dcterms:modified>" : "") + "</cp:coreProperties>"
  ), $ == null || $.file("app.xml", Go(b, J)), a == null || a.file(
    "workbook.xml",
    `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"> <Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme" Target="theme/theme1.xml" /> <Relationship Id="rId2" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles" Target="styles.xml" /> <Relationship Id="rId3" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/sharedStrings" Target="sharedStrings.xml" /> ` + P + " </Relationships>"
  ...
  let oo = a == null ? void 0 : a.folder("theme");
  oo == null || oo.file(
    "theme1.xml",
    `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"  name="Office Theme"><a:themeElements><a:clrScheme name="Office"><a:dk1><a:sysClr val="windowText" lastClr="000000"/></a:dk1><a:lt1><a:sysClr val="window" lastClr="FFFFFF"/></a:lt1><a:dk2><a:srgbClr val="44546A"/></a:dk2><a:lt2><a:srgbClr val="E7E6E6"/></a:lt2><a:accent1><a:srgbClr val="5B9BD5"/></a:accent1><a:accent2><a:srgbClr val="ED7D31"/></a:accent2><a:accent3><a:srgbClr val="A5A5A5"/></a:accent3><a:accent4><a:srgbClr val="FFC000"/></a:accent4><a:accent5><a:srgbClr val="4472C4"/></a:accent5><a:accent6><a:srgbClr val="70AD47"/></a:accent6><a:hlink><a:srgbClr val="0563C1"/></a:hlink><a:folHlink><a:srgbClr val="954F72"/></a:folHlink></a:clrScheme><a:fontScheme name="Office"><a:majorFont><a:latin typeface="Calibri Light" panose="020F0302020204030204"/><a:ea typeface=""/><a:cs typeface=""/><a:font script="Jpan" typeface="游ゴシック Light"/><a:font script="Hang" typeface="맑은 고딕"/><a:font script="Hans" typeface="等线 Light"/><a:font script="Hant" typeface="新細明體"/><a:font script="Arab" typeface="Times New Roman"/><a:font script="Hebr" typeface="Times New Roman"/><a:font script="Thai" typeface="Tahoma"/><a:font script="Ethi" typeface="Nyala"/><a:font script="Beng" typeface="Vrinda"/><a:font script="Gujr" typeface="Shruti"/><a:font script="Khmr" typeface="MoolBoran"/><a:font script="Knda" typeface="Tunga"/><a:font script="Guru" typeface="Raavi"/><a:font script="Cans" typeface="Euphemia"/><a:font script="Cher" typeface="Plantagenet Cherokee"/><a:font script="Yiii" typeface="Microsoft Yi Baiti"/><a:font script="Tibt" typeface="Microsoft Himalaya"/><a:font script="Thaa" typeface="MV Boli"/><a:font script="Deva" typeface="Mangal"/><a:font script="Telu" typeface="Gautami"/><a:font script="Taml" typeface="Latha"/><a:font script="Syrc" typeface="Estrangelo Edessa"/><a:font script="Orya" typeface="Kalinga"/><a:font script="Mlym" typeface="Kartika"/><a:font script="Laoo" typeface="DokChampa"/><a:font script="Sinh" typeface="Iskoola Pota"/><a:font script="Mong" typeface="Mongolian Baiti"/><a:font script="Viet" typeface="Times New Roman"/><a:font script="Uigh" typeface="Microsoft Uighur"/><a:font script="Geor" typeface="Sylfaen"/></a:majorFont><a:minorFont><a:latin typeface="Calibri" panose="020F0502020204030204"/><a:ea typeface=""/><a:cs typeface=""/><a:font script="Jpan" typeface="游ゴシック"/><a:font script="Hang" typeface="맑은 고딕"/><a:font script="Hans" typeface="等线"/><a:font script="Hant" typeface="新細明體"/><a:font script="Arab" typeface="Arial"/><a:font script="Hebr" typeface="Arial"/><a:font script="Thai" typeface="Tahoma"/><a:font script="Ethi" typeface="Nyala"/><a:font script="Beng" typeface="Vrinda"/><a:font script="Gujr" typeface="Shruti"/><a:font script="Khmr" typeface="DaunPenh"/><a:font script="Knda" typeface="Tunga"/><a:font script="Guru" typeface="Raavi"/><a:font script="Cans" typeface="Euphemia"/><a:font script="Cher" typeface="Plantagenet Cherokee"/><a:font script="Yiii" typeface="Microsoft Yi Baiti"/><a:font script="Tibt" typeface="Microsoft Himalaya"/><a:font script="Thaa" typeface="MV Boli"/><a:font script="Deva" typeface="Mangal"/><a:font script="Telu" typeface="Gautami"/><a:font script="Taml" typeface="Latha"/><a:font script="Syrc" typeface="Estrangelo Edessa"/><a:font script="Orya" typeface="Kalinga"/><a:font script="Mlym" typeface="Kartika"/><a:font script="Laoo" typeface="DokChampa"/><a:font script="Sinh" typeface="Iskoola Pota"/><a:font script="Mong" typeface="Mongolian Baiti"/><a:font script="Viet" typeface="Arial"/><a:font script="Uigh" typeface="Microsoft Uighur"/><a:font script="Geor" typeface="Sylfaen"/></a:minorFont></a:fontScheme><a:fmtScheme name="Office"><a:fillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:gradFill rotWithShape="1"><a:gsLst><a:gs pos="0"><a:schemeClr val="phClr"><a:lumMod val="110000"/><a:satMod val="105000"/><a:tint val="67000"/></a:schemeClr></a:gs><a:gs pos="50000"><a:schemeClr val="phClr"><a:lumMod val="105000"/><a:satMod val="103000"/><a:tint val="73000"/></a:schemeClr></a:gs><a:gs pos="100000"><a:schemeClr val="phClr"><a:lumMod val="105000"/><a:satMod val="109000"/><a:tint val="81000"/></a:schemeClr></a:gs></a:gsLst><a:lin ang="5400000" scaled="0"/></a:gradFill><a:gradFill rotWithShape="1"><a:gsLst><a:gs pos="0"><a:schemeClr val="phClr"><a:satMod val="103000"/><a:lumMod val="102000"/><a:tint val="94000"/></a:schemeClr></a:gs><a:gs pos="50000"><a:schemeClr val="phClr"><a:satMod val="110000"/><a:lumMod val="100000"/><a:shade val="100000"/></a:schemeClr></a:gs><a:gs pos="100000"><a:schemeClr val="phClr"><a:lumMod val="99000"/><a:satMod val="120000"/><a:shade val="78000"/></a:schemeClr></a:gs></a:gsLst><a:lin ang="5400000" scaled="0"/></a:gradFill></a:fillStyleLst><a:lnStyleLst><a:ln w="6350" cap="flat" cmpd="sng" algn="ctr"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:prstDash val="solid"/><a:miter lim="800000"/></a:ln><a:ln w="12700" cap="flat" cmpd="sng" algn="ctr"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:prstDash val="solid"/><a:miter lim="800000"/></a:ln><a:ln w="19050" cap="flat" cmpd="sng" algn="ctr"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:prstDash val="solid"/><a:miter lim="800000"/></a:ln></a:lnStyleLst><a:effectStyleLst><a:effectStyle><a:effectLst/></a:effectStyle><a:effectStyle><a:effectLst/></a:effectStyle><a:effectStyle><a:effectLst><a:outerShdw blurRad="57150" dist="19050" dir="5400000" algn="ctr" rotWithShape="0"><a:srgbClr val="000000"><a:alpha val="63000"/></a:srgbClr></a:outerShdw></a:effectLst></a:effectStyle></a:effectStyleLst><a:bgFillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:solidFill><a:schemeClr val="phClr"><a:tint val="95000"/><a:satMod val="170000"/></a:schemeClr></a:solidFill><a:gradFill rotWithShape="1"><a:gsLst><a:gs pos="0"><a:schemeClr val="phClr"><a:tint val="93000"/><a:satMod val="150000"/><a:shade val="98000"/><a:lumMod val="102000"/></a:schemeClr></a:gs><a:gs pos="50000"><a:schemeClr val="phClr"><a:tint val="98000"/><a:satMod val="130000"/><a:shade val="90000"/><a:lumMod val="103000"/></a:schemeClr></a:gs><a:gs pos="100000"><a:schemeClr val="phClr"><a:shade val="63000"/><a:satMod val="120000"/></a:schemeClr></a:gs></a:gsLst><a:lin ang="5400000" scaled="0"/></a:gradFill></a:bgFillStyleLst></a:fmtScheme></a:themeElements><a:objectDefaults/><a:extraClrSchemeLst/><a:extLst><a:ext uri="{05A4C25C-085E-4340-85A3-A5531E510DB2}"><thm15:themeFamily xmlns:thm15="http://schemas.microsoft.com/office/thememl/2012/main" name="Office Theme" id="{62F939B6-93AF-4DB8-9C6B-D6C7DFDC589F}" vid="{4A3C46E8-61CC-4603-A589-7422A47A8E4A}"/></a:ext></a:extLst></a:theme>`
  ...
  if (E.forEach((g, t) => {
    ...
    let p = "";
    if (h.hasImages) {
      const L = `drawing${so.length + 1}.xml`;
      so.push(L), y == null || y.file(
        L,
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
${h.drawersContent}
      ...
      ), p += `<Relationship Id="rId2"
        Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/drawing"
        Target="../drawings/${L}" />`;
    }
    if (h.hasComment) {
      ho.push(t + 1);
      let L = h.commentAuthor;
      a == null || a.file(
        `comments${t + 1}.xml`,
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<comments xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
	...
	<commentList>
      ...
      ), p += `  <Relationship Id="rId1"
        Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/comments"
        Target="../comments${t + 1}.xml" />
    <Relationship Id="rId3"
        Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/vmlDrawing"
        Target="../drawings/vmlDrawing${t + 1}.vml" />`, y == null || y.file(
        "vmlDrawing" + (t + 1) + ".vml",
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<xml xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:oa="urn:schemas-microsoft-com:office:activation" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns:pvml="urn:schemas-microsoft-com:office:powerpoint">
 ...
 </v:shapetype>${h.shapeCommentRowCol.reduce((lo, x) => lo + `<v:shape id="_x0000_s1025" type="#_x0000_t202" style='position:absolute;
...
function oc(o) {
  ...
  for (let i = 0; i < c; i++) {
    ...
    for (let v = 0; v < w; v++) {
      ...
      let F = [];
      const P = e[f].headers.length;
      let N = {}, O = e[f].seenAt == i, J = n.headers.reduce((E, T, $) => (e[f].labelConter++, P < e[f].labelConter && F.push({
      ...
      if (e[f].headers.push(...F), n.spaceX)
        for (let E = 0; E < n.spaceX; E++)
          e[f].labelConter++, P <= e[f].labelConter && e[f].headers.push({
            label: "c" + e[f].labelConter,
            text: ""
          });
      r[f].index + 1 == i && (I[f] = r[f].value);
      let S = I[f] || 0;
      S > 0 && (!e[f].headerIndex || e[f].headerIndex && e[f].headerIndex != S ? e[f].data.push(N) : e[f].data[S] = {
        ...e[f].data[S],
        ...N
      }, e[f].headerIndex = S, S++);
      let D = Object.keys(J), V = n.data.length >= e[f].data.length;
      if (e[f].data = n.data.reduce((E, T, $) => {
        let q = {};
        return E.length > $ + S ? q = E[$ + S] : E.push(q), D.forEach((oo) => {
          let z = J[oo];
          q[z] = T[oo] ? T[oo] : "";
        }), q.tableIndex = l, q.tableStringIndex = $ + "," + v, E[$ + S] = q, E;
      }, e[f].data), V && n.spaceY) {
        const E = e[f].headers.length;
        for (let T = 0; T < n.spaceY; T++) {
          let $ = {};
          for (let q = 0; q < E; q++) {
            const oo = e[f].headers[q];
            $[oo.label] = "";
          }
          e[f].data.push($);
        }
...
export {
  cc as convertTableToExcel,
  _o as generateExcel,
  lc as sideBySideLineByLine,
  fc as themeBaseGenerate
};
