//#region src/utils/generate-column-name.ts
function e(t, n, r = "", i = [], a = -1) {
	let o = t.length;
	for (let e = 0; e < o; e++) i.push(r + t[e]);
	return n < i.length ? i : e(t, n, i[a + 1], i, a + 1);
}
//#endregion
//#region src/data-model/const-data.ts
var t = {
	percentage: { key: 9 },
	fraction: { key: 13 },
	short_date: { key: 14 },
	...
	float_1: {
		key: 180,
		value: "<numFmt numFmtId=\"180\" formatCode=\"0.0\" />"
	},
	float_2: {
		key: 181,
		value: "<numFmt numFmtId=\"181\" formatCode=\"0.00\" />"
	},
	float_4: {
		key: 182,
...
}, n = /* @__PURE__ */ "ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");
//#endregion
//#region src/utils/excel-util.ts
function r(t, n) {
	if (t = t.toUpperCase(), !/^[A-Z]+[0-9]+$/.test(t)) throw "Invalid Reference";
	let r = t.replace(/[0-9]/g, ""), i = parseInt(t.substring(r.length));
	i = Math.max(0, i - 1);
	let a = n.indexOf(r);
	return a < 0 && (n = e(n, 10 ** (r.length + 1), ""), a = n.indexOf(r)), {
		col: a,
		row: i
	};
}
