import {
  ...
  AlignmentOption,
  BorderOption,
} from "mr-excel/dist2/src/data-model/excel-table";
interface Example {
  data: ExcelTable;
  str?: string;
...
export const ex1: Example = (function () {
...
export const ex6: Example = (() => {
  function generateData() {
    ...
    let merge: {
      [key: string]: Header | string | number;
    } = {};
...
export const ex9: Example = (() => {
  function generateData() {
    const colorPalette = {
      c4: "2B2E4A",
      c2: "E84545",
    };
    const rowAlignment:StyleBody= {
      alignment: {
        horizontal: "left",
        vertical: "center",
      },
