...
exports.ex9 = exports.ex8 = exports.ex7 = exports.ex6 = exports.ex5 = exports.ex4 = exports.ex3 = exports.ex2 = exports.ex1 = exports.ex = void 0;
const dataset = [
    {
        id: 7209449538085,
        name: "Tabitha",
...
exports.ex1 = (function () {
    ...
    return Object.assign(Object.assign({}, generateData()), { str: generateData.toString() });
})();
exports.ex2 = {
...
exports.ex4 = (() => {
    ...
    return Object.assign(Object.assign({}, generateData()), { srs: generateData.toString() });
})();
exports.ex5 = (() => {
    function generateData() {
        const colorPalette = {
        ...
        return {
            ...
            data: {
                creator: "mr",
                styles: {
                    Date: Object.assign(Object.assign({}, rowStyle), { format: "short_date" }),
                    Time: Object.assign(Object.assign({}, rowStyle), { format: "time" }),
                    Percentage: Object.assign(Object.assign({}, rowStyle), { format: "percentage" }),
                    Float: Object.assign(Object.assign({}, rowStyle), { format: "float_2", alignment: {
                            horizontal: "left",
                        } }),
                    Fraction: Object.assign(Object.assign({}, rowStyle), { format: "fraction" }),
                    "Long Number Column 1": Object.assign(Object.assign({}, rowStyle), { format: "dollar_2", alignment: {
                            indent: 3,
                            rtl: true,
                            horizontal: "left",
                        } }),
                    "Long Number Column 2": Object.assign(Object.assign({}, rowStyle), { format: "num_sep", alignment: {
                            ltr: true,
                            horizontal: "left",
                        } }),
                ...
                sheet: [
                    {
                        styleCellCondition(data, object, colIndex, rowIndex, fromHeader, stylekeys) {
    ...
    return Object.assign({ str: generateData.toString() }, generateData());
})();
exports.ex6 = (() => {
    function generateData() {
        const colorPalette = {
        ...
        return {
            ...
            data: {
                ...
                styles: {
                    ...
                    Time: Object.assign(Object.assign({}, rowStyle), { format: "time" }),
                    Percentage: Object.assign(Object.assign({}, rowStyle), { format: "percentage" }),
                    Float: Object.assign(Object.assign({}, rowStyle), { format: "float_2" }),
                    Fraction: Object.assign(Object.assign({}, rowStyle), { format: "fraction" }),
                    "Long Number Column 1": Object.assign(Object.assign({}, rowStyle), { format: "dollar_2" }),
                    "Long Number Column 2": Object.assign(Object.assign({}, rowStyle), { format: "num_sep" }),
                    headerStyle: Object.assign({}, headerStyle),
                },
                sheet: [
                    {
